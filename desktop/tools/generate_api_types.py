...
export interface CoreBootstrap { brand: string; product: string; version: string; languages: Array<{ value: string; label: string }>; model_capabilities: { key: string; name: string; version: string; offline: boolean; lazy_load: boolean }; defaults: { preset: "标准" | "兼容"; parameters: SynthesisParameters }; }
...
export interface BootstrapPayload { brand: string; product: string; version: string; projects: ProjectSummary[]; voices: VoiceAsset[]; styles: StylePreset[]; runtime: RuntimeSnapshot; metrics: HardwareMetrics; languages: Array<{ value: string; label: string }>; modules: ModuleDescriptor[]; }
